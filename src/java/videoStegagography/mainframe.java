...
class mainframe extends JFrame implements ActionListener, Runnable {
    ...
    public mainframe() throws Exception {
        ...
        super("Steganography Using Video");
        ...
        Ltitle = new JLabel("IGEN-Steganography Using Video");
        ...
        String messs = Amessage.getText();
        System.out.println("messs " + messs);
    ...
    public void Audioencrypt(String message, File file, int key)
        ...
        OutputStream outs = new FileOutputStream(new File("D:/example/xyz.flv"));
        File f = new File("D:/workspace/example/com/abc.txt");
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        try {
            ...
            // Action for Decrypt button
                ...
                String messageone = Amessage.getText();
                if (Copened == 1) {
                    Dkey = JOptionPane
            ...
            // Action for Play button
                ...
                if (Copened == 1) {
                    ...
                    JOptionPane.showMessageDialog(this, "File NotOped",
                            "Error", JOptionPane.ERROR_MESSAGE);
                }
            ...
            // Action for open Button
                ...
                if (r == JFileChooser.CANCEL_OPTION) {
                    ...
                    if (!(name.endsWith(".flv"))) {
                        JOptionPane.showMessageDialog(this, "Select Only flv",
                                "Error", JOptionPane.ERROR_MESSAGE);
                    } else {
                        Copened = 1;
            ...
            // Action for Save Button
                ...
                if (Copened == 1 && Cencrypt == 1 || Cdecrypt == 1) {
                    ...
                    InputStream in = new FileInputStream("D:/example/xyz.flv");
