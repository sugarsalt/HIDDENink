    ...
    <head>
        ...
        <script>
            function truncateMessages()
            {
                ...
                xmlhttp.open("GET", "truncateMessages.jsp", true);
                xmlhttp.send();
            }
            function DeleteMessage(messageID)
            {
                ...
                xmlhttp.onreadystatechange = function()
                {
                    if (xmlhttp.readyState == 4 && xmlhttp.status == 200)
                    {
                        ...
                        document.getElementById("tableMessages").innerHTML = xmlhttp.responseText;
                    }
                }

                xmlhttp.open("GET", "DeleteMessage.jsp?messID=" + messageID, true);
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top">
            <div class="container-fluid">
                ...
                <ul class="nav navbar-nav" style="padding-left: 80px;font-family: majalla;font-size: 22px;">
                    ...
                    <li class="active"><a href="UserAction.jsp"><br>User Actions</a></li>
                </ul>
